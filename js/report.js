...
btn.forEach(val =>{
    val.addEventListener("click", (e)=>{
        ...
        if(e.target.innerHTML=="offices"){
            report__details.innerHTML = /*html*/`
                <my-details logic="offices_1" text="1. Devolvuelve un listado con el codigo de oficina y la ciudad donde hay oficinas."></my-details>
                <my-details logic="offices_2" text="2. Devuelve un listado con la ciudad y el telefono de las oficinas de españa."></my-details>
            `;
        }
    })
})
